...
export function getUserCountryCodeFromBrowser() {
  const localData = Intl.DateTimeFormat().resolvedOptions();
  const browserDetectedRegion = localData.timeZone.toLowerCase();

  const countryCode = countriesCodeByTimeZones[browserDetectedRegion] || 'US';

  return countryCode;
}

export default getUserCountryCodeFromBrowser;
