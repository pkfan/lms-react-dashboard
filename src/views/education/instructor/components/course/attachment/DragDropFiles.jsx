import { Grid, Stack, Box, Title } from '@mantine/core';
...
export function DragDropFiles({ items, setitems }) {
  // const [items, setitems] = useState(files);

  // console.log('DragDropFiles files :', files);
  console.log('DragDropFiles items :', items);
  ...
  const DragDropItemComponent = ({ item: file, index }) => {
    return (
      <Grid
        sx={(theme) => ({
