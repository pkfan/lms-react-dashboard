...
import { Stack, Flex, Title, Text, Loader } from '@mantine/core';
import { showNotification } from '@mantine/notifications';
import { Button, MultiSelectUserWithImage, Overlay, SwtichText } from '@/components';
import {
  useGetInstructorsQuery,
  useSetCourseInstructorsMutation,
} from '@/views/education/instructor/api';
import { courseInstructorRelation } from '@/enums';

import { IconX, IconCheck, FaSave, AiOutlineUsergroupAdd } from '@/components/icons';
