...
import { useGetChaptersQuery, useCreateChapterMutation } from '@/views/education/instructor/api';
import { NotFoundImage } from '@/components';
import { ChapterCard, ChapterCreateForm } from '@/views/education/instructor/components';
