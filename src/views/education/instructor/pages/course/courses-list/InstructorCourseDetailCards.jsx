...
import { useGetCoursesCountQuery } from '@/views/education/instructor/api';
...
export function InstructorCourseDetailCards({ submitViaCourseCard }) {
  const {
...
export default InstructorCourseDetailCards;
