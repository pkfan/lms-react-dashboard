// source
// https://codesandbox.io/s/react-data-table-mini-graph-ibgs6?file=/src/App.js:0-15011
...
export default function Example() {
  const columns = [
    ...
    {
      name: 'CountryImage',
      selector: (row) => <img src={row.CountryImage} width="50%" height="50%" />,
      sortable: true,
    },
    {
      name: 'Position',
    ...
    },
    {
      ...
      selector: (row) => {
        ...
        // return <MiniChart className={'p-3 mt-5'} strokeWidth={2} width={100} dataSet={arrayData} />;
  ...
  const playerSummary = [
    {
      ...
      Team: 'Aston Villa',
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t7.png',
      Country: 'Jamaica',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/jamaica-flag-png-large.png',
      Position: 'MID',
      Goals: 22,
      Apps: 23,
    },
    {
      ...
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t1.png',
      Country: 'Brazil',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/brazil-flag-png-large.png',
      Position: 'DEF',
      Goals: 21,
      Apps: 10,
    },
    {
      ...
      Team: 'Everton',
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t11.png',
      Country: 'England',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/england-flag-jpg-xl.jpg',
      Position: 'MID',
      Goals: 30,
      Apps: 23,
    },
    {
      ...
      Team: 'Spurs',
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t6.png',
      Country: 'Brazil',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/brazil-flag-png-large.png',
      Position: 'MID',
      Goals: 3,
    ...
    },
    {
      ...
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t43.png',
      Country: 'Portugal',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/portugal-flag-400.png',
      Position: 'MID',
      Goals: 5,
      Apps: 15,
    },
    {
      ...
      Team: 'Wolves',
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t39.png',
    ...
    },
    {
      ...
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t1.png',
      Country: 'Uruguay',
      CountryImage: 'https://www.countryflags.com/wp-content/uploads/uruguay-flag-png-large.png',
      Position: 'FWD',
      Goals: 2,
      Apps: 19,
    },
    {
      ...
      Team: 'Chelsea',
      TeamImage: 'https://resources.premierleague.com/premierleague/badges/50/t8.png',
      Country: 'England',
      'Country Image': 'https://www.countryflags.com/wp-content/uploads/england-flag-jpg-xl.jpg',
      Position: 'DEF',
      Goals: 12,
      Apps: 17,
    },
  ...
  return (
    <div className="App">
      <DataTable
        ...
        highlightOnHover
        striped
        actions={<button>this is action button</button>}
      />
